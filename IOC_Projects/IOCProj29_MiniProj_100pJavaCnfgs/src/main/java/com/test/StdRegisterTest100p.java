...
import com.config.RealtimeProjConfig;
import com.controller.StdController;
import com.model.StdModel;

public class StdRegisterTest100p {
	...
	public static void main(String[] args) {
		...
		try {
		AnnotationConfigApplicationContext ax= new AnnotationConfigApplicationContext(RealtimeProjConfig.class);	
